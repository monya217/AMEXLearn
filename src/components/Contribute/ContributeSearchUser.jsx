...
import useSearchUser from "../../hooks/useContributeSearchUser";
import SuggestedUser from "../GetInTouch/Sidebar/SuggestedUser";

const ContributeSearchUser = forwardRef(({ onClose: handleSidebarClose }, ref) => {
    ...
    const handleUserClick = () => {
        navigate(`/contribute/${user.username}`, { state: { user } });
        onClose();
    }
    const handleClose = () => {
        onClose();
...
export default ContributeSearchUser;
