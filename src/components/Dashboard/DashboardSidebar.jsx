...
import { Box, Flex, Heading, Text, Button, Table, Thead, Tbody, Tr, Th, Td, Image } from '@chakra-ui/react';
      ...
      <Box p={5} mt={10} flex="1">
        ...
        <Flex flexDirection={{ base: 'column', md: 'row' }} gap={10}>
          <Box p={5} shadow="md" borderWidth="1px" flex="1">
            ...
            {/* Display consultant image */}
            <Flex alignItems="center" mb={4}>
              <Image
                src="/consultant1.png" // Replace with the actual path to the image
                borderRadius="full"
                boxSize="100px"
                mr={4}
              />
