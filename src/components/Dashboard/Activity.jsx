  ...
  if (error) {
    ...
    return (
      <Flex flexDir="column" textAlign={"center"} mx={"auto"}>
        ...
        <Link as={RouterLink} to={"/"} color={"blue.500"} w={"max-content"} mx={"auto"} mt={10}>
          Go home
        </Link>
      </Flex>
    );
    ...
    <Flex>
      ...
      <Box p={5} mt={10} flex="1" ml={0}>
        ...
        <Container maxW="100%" px={0} ml={0}>
          ...
          <Flex px={{ base: 2, sm: 4 }} w="full" borderTop="1px solid" borderColor="whiteAlpha.300" flexDirection="column">
            <ActivityProfileTabs selectedTab={selectedTab} setSelectedTab={setSelectedTab} />
            <ActivityProfilePosts selectedTab={selectedTab} userProfile={userProfile} />
          </Flex>
        </Container>
      </Box>
    </Flex>
